...
def main():
    ...
    parser.add_argument('-v', '--visualize', action='store_true', help='Whether to print a 10x10 section of the sparse matrix.')
    ...
    with open(args.interactions, 'r') as infile:
        ...
        for line in infile:
            ...
            # update matrix
            i, j = int(values[startI_idx]) // binsize, int(values[startJ_idx]) // binsize
            if args.normalize:
